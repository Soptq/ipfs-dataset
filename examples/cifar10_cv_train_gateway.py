...
train_ipfs_objs = [
    IPFSObject("https://silver-effective-marten-531.mypinata.cloud/ipfs/QmdPw1vze5nwVM1fsCjygXCs8WyzDsf3hn4uq3MpMLvw9w", RemoteFileType.ZIP)
]
test_ipfs_objs = [
    IPFSObject("https://silver-effective-marten-531.mypinata.cloud/ipfs/QmUXbPZvz4NuM3StmxLJdSjoGWTJLxF2iTe3Afd4uLhPa1", RemoteFileType.ZIP)
]
...
train_dataset = Cifar10IPFS(train_ipfs_objs, ipfs_api_address, transform=transform_train)
